...
def reply():
    ...
    trash= (label[0][5])
    if cardboard >= 0.6:
        msg.body("It's cardboard and paper.Here's some information about it and how to recycle it")
        msg.body("""
...
-Save to send packages to other people.
        ...
        msg.body("It's glass.Here's some information about it and how to recycle it")
        msg.body("""
...
-Moulded or blown into new bottles or jars, not only these, we can use it to produce: Glass containers, Fiberglass, Recycled glass countertops, Foam aggregate, and Ground cover.
        ...
        msg.body(" It's metal.Here's some information about it and how to recycle it")
        msg.body("""
...
-Save to send packages to other people.
        ...
        msg.body("It's plastic.Here's some information about it and how to recycle it")
        msg.body("""
        Plastic: 
...
-Turn Plastic Bottle Trash Into a Trash Can.
        ...
        msg.body("This type of garbage is trash")
        msg.body("""
